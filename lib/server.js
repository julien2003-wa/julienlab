...
export async function ensureSchema() {
  ...
  schemaPromise = (async () => {
    ...
    await sql`ALTER TABLE jl_activation_keys ADD COLUMN IF NOT EXISTS assigned_email TEXT`;
    await sql`CREATE INDEX IF NOT EXISTS jl_activation_keys_created_idx ON jl_activation_keys(created_at DESC)`;
    await sql`CREATE INDEX IF NOT EXISTS jl_activation_keys_assigned_email_idx ON jl_activation_keys(assigned_email)`;
